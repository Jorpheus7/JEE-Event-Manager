...
public class InscriptionEvent extends HttpServlet {
    ...
    /** 
     *@see HttpServlet#lalal(HttpServletRequest request, HttpServletResponse response)
    */
    protected void lalal(HttpServletRequest request, HttpServletResponse response) throws IOException{
